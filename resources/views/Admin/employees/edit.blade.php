...
@section('Dashboard_title', 'Edit Employee Info')
...
@section('content')
    <div class="container">
        ...
        <h1 class="p-3 border text-center my-3">Edit Employee Info</h1>
        ...
        <form action="{{ route('employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6 mb-3">
                    ...
                    <input type="number" name="salary" value="{{ $employee->salary }}" class="form-control" step="0.01"
                        min="0" placeholder="Enter Employee Salary">
                ...
                <div class="form-group col-md-6 mb-3">
                    ...
                    <input type="date" name="start_date" value="{{ $employee->start_date }}" class="form-control">
                </div>
                <input type="hidden" name="user_id" value="{{ auth()->id() }}">

                <div class="form-group col-md-6 mb-3">
                    <label>Employee Image</label>
                    <input type="file" name="image" value="{{ $employee->image }}" class="form-control">
                </div>
