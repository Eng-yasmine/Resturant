                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" value="{{ auth()->user()->name ?? 'cant fined your name' }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="email" value="{{ auth()->user()->email ?? 'cant find your email' }}"
                                ...
                                <div class="form-floating">
                                    <select name="contact_type" id="">
                                        <option value="Booking" {{ old('contact_type') == 'Booking' ? 'selected' : '' }}>Booking</option>
                                        <option value="Technical" {{ old('contact_type') == 'Technical' ? 'selected' : '' }}>Technical</option>
                                        <option value="General" {{ old('contact_type') == 'General' ? 'selected' : '' }}>General</option>
                                    </select>
